  ...
  'inline-flex shrink-0 items-center justify-center gap-2 font-medium outline-none transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus-ring-strong disabled:pointer-events-none',
  {
    variants: {
      variant: {
        ...
        ghost:
          'bg-transparent text-foreground hover:bg-surface-hover disabled:opacity-40',
        destructive:
          'bg-danger text-primary-foreground hover:bg-danger/90 disabled:opacity-40',
        accent:
        ...
        link:
          'bg-transparent text-foreground underline-offset-4 hover:underline disabled:opacity-40',
      },
      size: {
