...
Generate a self-contained React + TypeScript + Vite application using plain CSS. Keep dependencies minimal. Do not require a backend, database, authentication service, shell command, external asset download, or secret. Prefer local SVG/CSS shapes or simple remote-free placeholders when visual assets are needed.
