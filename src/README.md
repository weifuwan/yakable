...
- **model** owns provider-specific transport for intent analysis, generation, Edit Intent normalization, Design Critic, focused editing, context selection, and the single build-repair request. Capability modules should not know DeepSeek HTTP details.
