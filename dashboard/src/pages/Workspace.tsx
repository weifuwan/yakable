      ...
      <div ref={toolbarRef} className="pointer-events-auto relative">
        ...
        >
          <button className={`${menuItemClass} bg-black/[0.075]`} type="button" role="menuitem">
            ...
            <svg className="!text-[#1B1B1B]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
        ...
        >
          ...
          >
            <div className="flex shrink-0 items-center gap-1">
              <button className={toolButtonClass} type="button" aria-label="Select elements" aria-pressed="false">
              ...
              <button className={toolButtonClass} type="button" aria-label="Edit text inline" aria-pressed="false">
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <button className={toolButtonClass} type="button" aria-label="Draw annotation" aria-pressed="false">
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <button className={toolButtonClass} type="button" aria-label="Add a comment" aria-pressed="false">
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <button className={`${toolButtonClass} -ml-1`} type="button" aria-label="Minimize toolbar">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
